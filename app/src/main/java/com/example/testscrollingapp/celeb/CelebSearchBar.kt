...
import com.example.testscrollingapp.ui.theme.SandYellow
...
fun CelebSearchBar(
    ...
    CompositionLocalProvider(
        ...
        OutlinedTextField(
            ...
            trailingIcon = {
                AnimatedVisibility(
                    visible = searchQuery.isNullOrBlank().not()
                ) {
                    IconButton(
                        onClick = {
                            onSearchQueryChange("")
...
fun CelebBarPreview() {
    TestScrollingAppTheme {
        CelebSearchBar(searchQuery = "Ashish", onSearchQueryChange = {}, onImeSearch = {})
    }
}